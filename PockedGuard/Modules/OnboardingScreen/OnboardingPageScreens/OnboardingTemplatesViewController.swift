//
//  OnboardingTemplatesViewController.swift
//  PockedGuard
//
...
final class OnboardingTemplatesViewController: UIViewController {
    // MARK: - UI Elements
    private lazy var backgroundView: UIImageView = {
        let imageView: UIImageView = .init()
        imageView.translatesAutoresizingMaskIntoConstraints = false
        imageView.image = UIImage(named: "backgroundOnboardingTemplates")
        return imageView
    }()
    ...
    private lazy var templateImageView: UIImageView = {
        let imageView: UIImageView = .init()
        imageView.translatesAutoresizingMaskIntoConstraints = false
        imageView.image = UIImage(named: "templateOnboarding")
...
private extension OnboardingTemplatesViewController {
    func setupUI() {
    ...
    func setConstraints() {
        NSLayoutConstraint.activate([
            ...
            templateImageView.bottomAnchor.constraint(equalTo: view.centerYAnchor,
